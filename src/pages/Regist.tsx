...
import {createSchemaField, Field, FormConsumer, FormProvider,} from "@formily/react";
...
function Regist() {
    ...
    const patientInfoSchema = {
        type: "object", properties: {
            photo: {
                type: "string", title: "Photo", "x-decorator": "FormItem", "x-decorator-props": {
                    gridSpan: "{{$self.value ? 2 : 1}}",
                }, "x-component": "PhotoTakField",
            }, patientSearch: {
                type: "void", title: "Patient Search", "x-decorator": "FormItem", "x-decorator-props": {
                ...
                "x-reactions": {
                    dependencies: [".singleName"], fulfill: {
                        state: {
                            required: "{{!$deps[0]}}",
                ...
                type: "void", "x-decorator": "FormItem", properties: {
                    givenName: {
                        type: "string",
                        required: true,
                        title: "Given Name",
                        "x-decorator": "FormItem",
                        "x-decorator-props": {
                            style: {display: "inline-flex"}, colon: false, labelWidth: 100,
                        },
                        "x-component": "Input",
                        "x-component-props": {
                            style: {width: 240},
                        ...
                        type: "boolean",
                        "x-component": (props: any) => (<Checkbox {...props}>Single Name</Checkbox>),
                        "x-component-props": {
                            style: {marginLeft: 8},
                        },
                        "x-reactions": {
                            dependencies: [".surname", ".givenName"], when: "{{$deps[0] && $deps[1]}}", fulfill: {
                                state: {
                ...
                type: "string",
                title: "Date of Birth",
                enum: [{label: "Male", value: "M"}, {label: "Female", value: "F"}, {label: "Unknown sex", value: "U"},],
                "x-decorator": "FormItem",
                "x-component": "Select",
                "x-component-props": {
                    style: {width: 240},
    ...
    const addressSharedSchema = {
        type: "void", "x-component": "FormGrid", "x-component-props": {
            maxColumns: 3,
        }, properties: {
            room: {
                type: "string",
    ...
    const contactInfoSchema = {
        type: "object", properties: {
            grid: {
                ...
                type: "object", "x-decorator": (props: any) => (<>
                ...
                type: "object", "x-decorator": (props: any) => (<>
                    <h3>
                        ...
                        <Field
                            name="same"
                            component={[() => (<Checkbox style={{marginLeft: 12}}>
                    ...
                    grid: {
                        ...addressSharedSchema, "x-reactions": {
                            dependencies: [".same"], fulfill: {
                                schema: {
                                    "x-visible": "{{!$deps[0]}}",
    ...
    const emergencyItemSchema = {
        type: "void", "x-component": "FormGrid", "x-component-props": {
            ...
            priority: {
                ...
                "x-component-props": {
                    style: {width: 240}, min: 1, precision: 0,
                },
            },
            contactType: {
                type: "string",
            ...
            proxyAccess: {
                ...
                "x-component": "Select",
                "x-component-props": {
                    style: {width: 240}, showSearch: true,
                },
                "x-reactions": {
                    dependencies: [".contactType"], fulfill: {
                        state: {
            ...
            remove: {
                type: "void", "x-decorator": "FormItem", "x-component": "CustomRemove", "x-component-props": {
    ...
    const schema = {
        type: "object", properties: {
            grid: {
                ...
                type: "void", "x-component": "FormTab", "x-component-props": {
                    formTab: "{{formTab}}",
                }, properties: {
                    tab1: {
                        type: "void", "x-component": "FormTab.TabPane", "x-component-props": {
                            tab: "Contact Info.",
                        }, properties: {
                        ...
                        type: "void", "x-component": "FormTab.TabPane", "x-component-props": {
                            ...
                            emergency: {
                                type: "array", "x-component": "ArrayItems", items: {
                                    type: "object", properties: {
                                        grid: emergencyItemSchema,
                                    },
                                }, properties: {
                                    add: {
                                        type: "void", "x-decorator": "FormItem", "x-decorator-props": {
                                            style: {textAlign: "center"},
                                        }, "x-component": "CustomAddition", "x-component-props": {
                                            onAddition: (array: any) => array.field.push({
